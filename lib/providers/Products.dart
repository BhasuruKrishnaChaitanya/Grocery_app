...
class ProductsProvider with ChangeNotifier {
  List<Product> _products = [
    Product(
        ...
        name: 'Kurkure',
        id: '1',
        categoryid: '1',quantity: ['10g','20g','30g']),
    Product(
        imagesrc:
    ...
    Product(
        ...
        name: 'Aata',
        id: '3',
        categoryid: '2',quantity: ['500g','1kg','2kg','5kg']),
    Product(
        imagesrc:
    ...
    Product(
        ...
        name: 'Salt',
        id: '5',
        categoryid: '2',quantity: ['500g','1kg']),
    Product(
        imagesrc:
    ...
    Product(
        ...
        name: 'pepsi',
        id: '8',
        categoryid: '4',quantity: ['250ml','500ml','1l']),
  ];
